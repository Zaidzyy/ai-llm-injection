...
<table>
<tr>
<td width="50%"><img src="images/04-harness-run.png" width="100%"></td>
<td width="50%"><img src="images/05-detector-scan.png" width="100%"></td>
</tr>
<tr>
<td><b>Harness</b> — ten technique classes scored and severity-weighted, exit-coded for CI</td>
<td><b>Detector</b> — indirect injection caught inside an untrusted document, with signal attribution</td>
</tr>
<tr>
<td width="50%"><img src="images/01-system-prompt-disclosure.png" width="100%"></td>
<td width="50%"><img src="images/02-safety-rules-listing.png" width="100%"></td>
</tr>
<tr>
<td><b>Policy baseline</b> — Grok's published operator rules, disclosed on request as designed (<i>not</i> a bypass — see below)</td>
<td><b>Stated controls</b> — the safety rules the vendor documents as non-overridable, used as the yardstick for the finding</td>
</tr>
<tr>
<td colspan="2"><img src="images/03-configuration-surface-redacted.png" width="49%"></td>
</tr>
<tr>
<td colspan="2"><b>Delivery surface</b> — the first-party configuration field used in the finding. Payload redacted and withheld pending vendor response.</td>
</tr>
</table>
